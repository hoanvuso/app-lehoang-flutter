...
class ItemPromotionHome extends StatelessWidget {
  final NewObject promotion;

  ItemPromotionHome(this.promotion);
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        InkWell(
          onTap: () {
            Navigator.pushNamed(context, Constants.pageNewsDetail, arguments: promotion);
          },
          child: Container(
            width: 250.h,
            child: Column(
...
class ShimmerPromotion extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
