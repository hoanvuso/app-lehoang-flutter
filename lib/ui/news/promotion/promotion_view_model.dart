...
final promotionViewModel = ChangeNotifierProvider.autoDispose((ref) => PromotionViewModel(
...
class PromotionViewModel extends BaseLoadingChangeNotifier {
  ...
  PromotionViewModel(this._prefsProvider, this._newsRepository);

  Future<List<NewObject>?> loadPromotions(int page) {
    var request = RequestSearchNews(page: page, limit: 10, type: Constants.NEW_TYPE_PROMOTION);
