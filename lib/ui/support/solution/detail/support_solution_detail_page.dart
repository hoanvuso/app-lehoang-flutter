...
import 'package:flutter_lehoang_extracare/ui/support/solution/detail/support_solution_detail_view_model.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:url_launcher/url_launcher.dart';

class SupportSolutionDetailPage extends StatefulWidget {
  @override
  _SupportSolutionDetailPageState createState() => _SupportSolutionDetailPageState();
}

class _SupportSolutionDetailPageState extends State<SupportSolutionDetailPage> {
  SupportObject? _solution;
  ...
  Widget build(BuildContext context) {
    ...
    if (value != null) _solution = value as SupportObject;

    return Scaffold(
      body: BaseContainer(
        provider: supportSolutionDetailViewModel,
        child: Container(
          color: Colors.white,
          height: double.infinity,
          child: Column(
            children: [
              CommonTopbar(_solution?.name ?? 'Giải pháp'),
        ...
        webViewController?.loadUrl(
            urlRequest: URLRequest(
                url: Uri.dataFromString(
                    ...
                    '''<div class=\"ck-content\" style=\"font-size:60px;\" ><h1 class=\"text-big\" style=\"font-size:60px;\">Đầu ghi hình IP 8 kênh<br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Độ phân giải ghi hình tối đa: 4 Megapixels.</span><br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Chuẩn nén hình ảnh: H.265+/H.265/H.264+/H.264.</span><br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Khả Năng giải mã : 1-ch @ 4 MP / 2-ch @ 1080p</span><br>Hỗ trợ 1 ổ cứng SATA dung lượng cho mỗi ổ 6TB.<br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Băng thông đầu vào 60Mbps, băng thông đầu ra 60Mbps.</span><br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Xuất Hình : HDMI và VGA (1920 x 1080P).</span><br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Chất liệu: Kim Loại</span><br><span style=\"background-color:rgb(255,255,255);color:rgb(51,51,51);\">Nguồn điện: 12VDC-</span><span style=\"background-color:rgb(255,255,255);color:rgb(0,0,0);\">1.5 A</span></h1></div><link rel=\"stylesheet\" href=\"http://45.117.171.8/plugins/custom/ckeditor/content-styles.css?v5\" type=\"text/css\">"''',
                    mimeType: 'text/html',
